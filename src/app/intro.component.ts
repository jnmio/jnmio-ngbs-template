...
<div style="text-align:center" class="content">
    ...
    <div style="text-align:center" class="content footer">
      ...
      <img width="100" alt="Angular Logo" src="assets/svg/Bootstrap_logo.svg">
      <img width="100" alt="Angular Logo" src="assets/svg/Node.js_logo.svg">
      <img width="100" alt="Angular Logo" src="assets/svg/ts-node.png">
      <img width="100" alt="Angular Logo" src="assets/svg/typescriptlang-icon.svg">
</div>  
